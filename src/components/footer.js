    ...
    <footer className="footer-footer section-container">
      <div className="footer-max-width max-content-container">
        <div className="footer-container">
          <img
            alt="image"
            src="/playground_assets/images-200h.jpg"
        ...
        <div className="footer-links">
          <div className="footer-container2">
            ...
            <span className="footer-link">Maps</span>
            <span className="footer-link">Reviews</span>
            <span className="footer-link">Routes</span>
            <span className="footer-text07 footer-link">Services</span>
          </div>
          <div className="footer-container3">
            <span className="footer-text08">Resources</span>
            <span className="footer-link">iOS Version</span>
            <span className="footer-text10 footer-link">Android Version</span>
          </div>
        </div>
      </div>
    </footer>
